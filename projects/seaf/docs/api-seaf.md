...
**请求**
```
GET /seaf/api/go_internal/get_tag_list?scenario_id=29
```
...
| 参数 | 值 | 说明 |
|------|------|------|
| Auth-Token | `SR6B310fsir2pGnAQ8iG3oT4J2iR3xJd` | 固定写死 |

**Query 参数**

| 参数 | 必选 | 类型 | 说明 |
|------|------|------|------|
| scenario_id | 是 | string | 场景 ID，智能体模版标签固定为 `29` |
